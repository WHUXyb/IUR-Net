...
class Prediction(object):
    def __init__(self, args):
        ...
        self.val_loader, self.list_filename = get_data_loaders(args, AQSDataset)
        self.model = AQSNet(in_channels=4, backbone='hrnet48',
                            with_mode='TripletAttention', with_aux=args.with_aux).to(self.device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--network_name', type=str, default='AQSNet')
    ...
    parser.add_argument('--weight_path', type=str, default=r'C:\Users\xiong\Desktop\RefineNet\trained_weights\waqs\aqsnet_waqs_hrnet.pth')
